...
import static com.android.internal.util.lineage.PowerMenuConstants.*;
...
class GlobalActionsDialog implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener  {
    ...
    private final class RestartAction extends SinglePressAction {
        ...
        @Override
        public void onPress() {
            boolean advancedRebootCapable = RebootUtils.isAdvancedRebootPossible(mContext);
            mWindowManagerFuncs.reboot(false, advancedRebootCapable);
        }
    }
